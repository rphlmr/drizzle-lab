...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn("flex flex-col bg-popover rounded-md size-full overflow-hidden text-popover-foreground", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn(
      "max-h-[300px] overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-primary",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator ref={ref} className={cn("-mx-1 bg-border h-px", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex items-center aria-[selected='true']:bg-accent data-[disabled='true']:opacity-50 px-2 py-1.5 rounded-sm outline-none text-sm aria-[selected='true']:text-accent-foreground cursor-pointer data-[disabled='true']:pointer-events-none select-none",
      className
    )}
    {...props}
  />
