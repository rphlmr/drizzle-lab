...
import { provider, projectId } from "../config/schema";
import { mapValues, originUUID, snapshotVersion } from "../internal/global";
import { relation } from "../internal/relations";

// fork: drizzle-kit/src/serializer/pgSchema.ts
...
const column = object({
  ...
  identity: sequenceSchema
    ...
    .optional(),
  /* lab extension */
  enumValues: string().array().optional(),
  defaultFn: string().optional(),
  onUpdateFn: string().optional(),
...
export const policy = object({
  name: string(),
  as: enumType(["PERMISSIVE", "RESTRICTIVE"]).optional().default("PERMISSIVE"),
  for: enumType(["ALL", "SELECT", "INSERT", "UPDATE", "DELETE"])
    .optional()
    .default("ALL"),
...
export type SequenceSquashed = TypeOf<typeof sequenceSquashed>;
export type Role = TypeOf<typeof roleSchema>;
export type Column = TypeOf<typeof column>;
export type ColumnSquashed = TypeOf<typeof columnSquashed>;
...
/* lab extension */
export type SnapshotSquashed = TypeOf<typeof pgSchemaSquashed>;
...
/* lab extension */
// squashPgScheme
export const squashSnapshot = (
  json: Snapshot,
  action: "push" | undefined = "push",
): SnapshotSquashed => {
