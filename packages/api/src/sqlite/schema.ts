...
import { customMapEntries, mapValues, originUUID } from "../internal/global";
import { relation } from "../internal/relations";

// fork: drizzle-kit/src/serializer/sqliteSchema.ts
...
/* lab extension */
export type Snapshot = SQLiteSchemaInternal;
export type SQLiteSchemaSquashed = TypeOf<typeof schemaSquashed>;
/* lab extension */
export type SnapshotSquashed = SQLiteSchemaSquashed;
